...
class Monitor {
     ...
     * @var string
     */
    private $dataTemplateCSS = 'position: fixed; bottom: 20px !important; left:20px; box-shadow:0 0 8px #555; background: #FFF; padding: 5px; color:#000 !important; z-index: 9999';
