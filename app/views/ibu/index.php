            ...
            <div class="navbar navbar-inverse">
                <div class="container">
                    <div class="navbar-header">
                        <a href="#" class="navbar-brand">Daftar Ibu</a>
                    </div>
                    <div class="navbar-collapse collapse navbar-inverse-collapse">
                        <ul class="nav navbar-nav">
                            <li><a class="btn-info" href="<?php echo App::instance()->base_url; ?>Ibu/tambah"><i class="icon-plus-sign icon-white"> </i> Tambah Data Ibu</a></li>
                        </ul>
                    ...
                    <tbody>
                        <?php foreach ($daftar_ibu as $value) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo $this->base_url . 'Ibu/edit/' . $value['id'] ?>"><i class="icon-pencil"></i></a>
                                    <a href="<?php echo $this->base_url . 'Ibu/kartu/' . $value['id'] ?>" ><i class="icon-camera"></i></a>
                                    <a href="<?php echo $this->base_url . 'Ibu/hapus/' . $value['id'] ?>" class="hapus"><i class="icon-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
