            ...
            <div class="navbar navbar-inverse">
                <div class="container">
                    <div class="navbar-header">
                        <a href="#" class="navbar-brand">Edit Ibu PKK / Bidan</a>
                    </div>
                </div><!-- /.container -->
            </div><!-- /.navbar -->
        </div>
                            ...
                            <table width="100%" class="table-form">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        echo $this->html->dropDownList('jabatan', $option, array($jabatan), "required style=\"width: 400px\" autofocus class=\"form-control\"");
